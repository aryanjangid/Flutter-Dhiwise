...
class ColorConstant {
  ...
  static Color bluegray60000 = fromHex('#00594683');

  static Color greenA40063 = fromHex('#6311cf74');

  static Color bluegray6001 = fromHex('#0053577a');
  ...
  static Color deepPurpleA201 = fromHex('#9a49f2');
  ...
  static Color deepPurpleA401 = fromHex('#8516ff');
  ...
  static Color bluegray60070 = fromHex('#7053577a');

  static Color tealA70026 = fromHex('#2608c6af');

  static Color bluegray801 = fromHex('#242b5c');
  ...
  static Color indigo90089 = fromHex('#89392670');

  static Color indigo1008c = fromHex('#8cc6bede');

  static Color whiteA700 = fromHex('#ffffff');

  static Color bluegray80067 = fromHex('#67242b5c');

  static Color deepPurpleA20033 = fromHex('#336349fd');

  static Color deepPurpleA20034 = fromHex('#339a49f2');
  ...
  static Color bluegray3002d = fromHex('#2d9297bd');
  ...
  static Color bluegray300Aa = fromHex('#aa9297bd');

  static Color indigoA40067 = fromHex('#674466e2');

  static Color orange301 = fromHex('#f2b848');

  static Color orange300 = fromHex('#fdb549');

  static Color bluegray600B7 = fromHex('#b753577a');

  static Color gray100 = fromHex('#f5f4f7');

  static Color bluegray6004f = fromHex('#4f53577a');
