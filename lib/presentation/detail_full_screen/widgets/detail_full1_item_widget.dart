...
import '../models/detail_full1_item_model.dart';
...
class DetailFull1ItemWidget extends StatelessWidget {
  DetailFull1ItemWidget(this.detailFull1ItemModelObj);

  DetailFull1ItemModel detailFull1ItemModelObj;

  var controller = Get.find<DetailFullController>();
                    ...
                    Align(
                      ...
                      child: ClipRRect(
                        ...
                        child: CommonImageView(
                          imagePath: ImageConstant.imgShape36,
                          height: getVerticalSize(
                            160.00,
                          ),
                          width: getHorizontalSize(
